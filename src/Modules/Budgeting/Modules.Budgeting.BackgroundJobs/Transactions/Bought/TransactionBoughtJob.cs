...
public sealed class TransactionBoughtJob(
    ...
    IValidator<BuyConfirmedJobData> validator) : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        var jobData = new BuyConfirmedJobData
        {
        ...
        try
        {
            ...
            var request = new PurchaseConfirmedEmail(
                jobData.UserEmail, 
                jobData.TotalAmount, 
                jobData.Quantity,
                jobData.CreatedOnUtc);
            ...
            var auditLog = AuditLog.Create(
                ...
                action: $"Bought {jobData.Quantity} shares",
            ...
            logger.LogInformation("Successfully sent purchase confirmed email to {Email} for user {UserId}.", jobData.UserEmail, jobData.UserId);
        }
        catch (Exception ex)
        {
